...
export const NPC_SHIPS = [
	...
	{ value: 'bfrNpcDD', id: 2,  label: 'NPC Ship', type: 'Destroyer', faction: FACTIONS[1].value, factionName: FACTIONS[1].label, plasmaProjectors: PLASMA_PROJECTORS[1],  torpedoes: TORPEDOES[0], shields: SHIELDS[0], signature: 3, x: -5, y: -5, inCombat: false, sublightSpeed: 4, inRangeMsg: 'Out of Weapons Range', inRangePP: false, inRangeT: false, hullHp: 20, hullMax: 20 },
	...
	{ value: 'cnpNpcDD', id: 3, label: 'NPC Ship', type: 'Destroyer', faction: FACTIONS[2].value, factionName: FACTIONS[2].label, plasmaProjectors: PLASMA_PROJECTORS[2],  torpedoes: TORPEDOES[0], shields: SHIELDS[0], signature: 3, x: -5, y: 5, inCombat: false, sublightSpeed: 4, inRangeMsg: 'Out of Weapons Range', inRangePP: false, inRangeT: false, hullHp: 20, hullMax: 20 },
	...
	{ value: 'obNpcDD', id: 4, label: 'NPC Ship', type: 'Destroyer', faction: FACTIONS[3].value, factionName: FACTIONS[3].label, plasmaProjectors: PLASMA_PROJECTORS[0],  torpedoes: TORPEDOES[0], shields: SHIELDS[0], signature: 3, x: 5, y: -5, inCombat: false, sublightSpeed: 4, inRangeMsg: 'Out of Weapons Range', inRangePP: false, inRangeT: false, hullHp: 20, hullMax: 20 },
	...
	{ value: 'tsccNpcDD', id: 5, label: 'NPC Ship', type: 'Destroyer', faction: FACTIONS[4].value, factionName: FACTIONS[4].label, plasmaProjectors: PLASMA_PROJECTORS[0], torpedoes: TORPEDOES[0], shields: SHIELDS[0], signature: 3, x: 5, y: 5, inCombat: false, sublightSpeed: 4, inRangeMsg: 'Out of Weapons Range', inRangePP: false, inRangeT: false, hullHp: 20, hullMax: 20}
...
export const STARTER_SHIPS = [
	{ value: 'monolith', label: 'Monolith', type: 'Freighter', faction: 'none',  plasmaProjectors: PLASMA_PROJECTORS[0],  torpedoes: null, shields: SHIELDS[0], martelDrive: 2, sublightSpeed: 2, scanner: 2, signature: 6, cargo: 0, cargoHold: [], cargoMax: 40, price: 0, hullHp: 20, hullMax: 20, description: 'A small but well rounded frieghter' },
