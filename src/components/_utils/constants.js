...
export const NPC_SHIPS = [
	{ value: 'uwcNpcDD', id: 1, label: 'NPC Ship', type: 'Destroyer', faction: FACTIONS[0].value, factionName: FACTIONS[0].label, plasmaProjectors: PLASMA_PROJECTORS[2],  torpedoes: TORPEDOES[0], shields: SHIELDS[0], signature: 3, x: 0, y: 0, inCombat: false, sublightSpeed: 4 },
	...
	{ value: 'bfrNpcDD', id: 2,  label: 'NPC Ship', type: 'Destroyer', faction: FACTIONS[1].value, factionName: FACTIONS[1].label, plasmaProjectors: PLASMA_PROJECTORS[1],  torpedoes: TORPEDOES[0], shields: SHIELDS[0], signature: 3, x: -5, y: -5, inCombat: false, sublightSpeed: 4 },
	...
	{ value: 'cnpNpcDD', id: 3, label: 'NPC Ship', type: 'Destroyer', faction: FACTIONS[2].value, factionName: FACTIONS[2].label, plasmaProjectors: PLASMA_PROJECTORS[2],  torpedoes: TORPEDOES[0], shields: SHIELDS[0], signature: 3, x: -5, y: 5, inCombat: false, sublightSpeed: 4 },
	...
	{ value: 'obNpcDD', id: 4, label: 'NPC Ship', type: 'Destroyer', faction: FACTIONS[3].value, factionName: FACTIONS[3].label, plasmaProjectors: PLASMA_PROJECTORS[0],  torpedoes: TORPEDOES[0], shields: SHIELDS[0], signature: 3, x: 5, y: -5, inCombat: false, sublightSpeed: 4 },
	...
	{ value: 'tsccNpcDD', id: 5, label: 'NPC Ship', type: 'Destroyer', faction: FACTIONS[4].value, factionName: FACTIONS[4].label, plasmaProjectors: PLASMA_PROJECTORS[0], torpedoes: TORPEDOES[0], shields: SHIELDS[0], signature: 3, x: 5, y: 5, inCombat: false, sublightSpeed: 4 }
...
export const STARTER_SHIPS = [
	...
	{ value: 'badger',   label: 'Badger',   type: 'Frigate',   faction: 'none',  plasmaProjectors: PLASMA_PROJECTORS[1],  torpedoes: TORPEDOES[0], shields: SHIELDS[1], martelDrive: 2, sublightSpeed: 3, scanner: 2, signature: 3, cargo: 0, cargoHold: [], cargoMax: 10, price: 0, description: 'The Badger provides good firepower for its size, but dont expect to win any fights against bigger ships.' },
