...
export const NPC_SHIPS = [
	...
	{ value: 'bfrNpcDD', id: null,  label: 'NPC Ship', type: 'Destroyer', faction: FACTIONS[1].value, factionName: FACTIONS[1].label, plasmaProjectors: PLASMA_PROJECTORS[1],  torpedoes: TORPEDOES[0], shields: SHIELDS[0], signature: 3, x: -19, y: -19, inCombat: false, isDestroyed: false, sublightSpeed: SUBLIGHT_DRIVES[1], inRangeMsg: 'Out of Weapons Range', hullHp: 20, hullMax: 20, combatPositionX: null, combatPositionY: null },

	{ value: 'cnpNpcDD', id: null, label: 'NPC Ship', type: 'Destroyer', faction: FACTIONS[2].value, factionName: FACTIONS[2].label, plasmaProjectors: PLASMA_PROJECTORS[2],  torpedoes: TORPEDOES[0], shields: SHIELDS[0], signature: 3, x: -19, y: 19, inCombat: false, isDestroyed: false, sublightSpeed: SUBLIGHT_DRIVES[1], inRangeMsg: 'Out of Weapons Range', hullHp: 20, hullMax: 20, combatPositionX: null, combatPositionY: null },

	{ value: 'obNpcDD', id: null, label: 'NPC Ship', type: 'Destroyer', faction: FACTIONS[3].value, factionName: FACTIONS[3].label, plasmaProjectors: PLASMA_PROJECTORS[0],  torpedoes: TORPEDOES[0], shields: SHIELDS[0], signature: 3, x: 19, y: -19, inCombat: false, isDestroyed: false, sublightSpeed: SUBLIGHT_DRIVES[1], inRangeMsg: 'Out of Weapons Range', hullHp: 20, hullMax: 20, combatPositionX: null, combatPositionY: null },

	{ value: 'tsccNpcDD', id: null, label: 'NPC Ship', type: 'Destroyer', faction: FACTIONS[4].value, factionName: FACTIONS[4].label, plasmaProjectors: PLASMA_PROJECTORS[0], torpedoes: TORPEDOES[0], shields: SHIELDS[0], signature: 3, x: 19, y: 19, inCombat: false, isDestroyed: false, sublightSpeed: SUBLIGHT_DRIVES[1], inRangeMsg: 'Out of Weapons Range', hullHp: 20, hullMax: 20, combatPositionX: null, combatPositionY: null }
]
