...
export const SHIELDS = [
	{ name: 'Shields MK1',  value: 'S-MK2',  shieldsHp: 20, shieldsRegen: 2 },
	{ name: 'Shields MK2',  value: 'S-MK2',  shieldsHp: 30, shieldsRegen: 3 },
	{ name: 'Shields MK3',  value: 'S-MK2',  shieldsHp: 40, shieldsRegen: 4 }
]
...
export const NPC_SHIPS = [
	{ value: 'uwcNpcDD', id: 1, label: 'NPC Ship', type: 'Destroyer', faction: FACTIONS[0].value, factionName: FACTIONS[0].label, plasmaProjectors: PLASMA_PROJECTORS[2],  torpedoes: TORPEDOES[0], shields: SHIELDS[0], signature: 3, x: 0, y: 0, inCombat: false, sublightSpeed: 5 },
	...
	{ value: 'bfrNpcDD', id: 2,  label: 'NPC Ship', type: 'Destroyer', faction: FACTIONS[1].value, factionName: FACTIONS[1].label, plasmaProjectors: PLASMA_PROJECTORS[1],  torpedoes: TORPEDOES[0], shields: SHIELDS[0], signature: 3, x: -5, y: -5, inCombat: false, sublightSpeed: 5 },
	...
	{ value: 'cnpNpcDD', id: 3, label: 'NPC Ship', type: 'Destroyer', faction: FACTIONS[2].value, factionName: FACTIONS[2].label, plasmaProjectors: PLASMA_PROJECTORS[2],  torpedoes: TORPEDOES[0], shields: SHIELDS[0], signature: 3, x: -5, y: 5, inCombat: false, sublightSpeed: 5 },
	...
	{ value: 'obNpcDD', id: 4, label: 'NPC Ship', type: 'Destroyer', faction: FACTIONS[3].value, factionName: FACTIONS[3].label, plasmaProjectors: PLASMA_PROJECTORS[0],  torpedoes: TORPEDOES[0], shields: SHIELDS[0], signature: 3, x: 5, y: -5, inCombat: false, sublightSpeed: 5 },
	...
	{ value: 'tsccNpcDD', id: 5, label: 'NPC Ship', type: 'Destroyer', faction: FACTIONS[4].value, factionName: FACTIONS[4].label, plasmaProjectors: PLASMA_PROJECTORS[0], torpedoes: TORPEDOES[0], shields: SHIELDS[0], signature: 3, x: 5, y: 5, inCombat: false, sublightSpeed: 5 }
